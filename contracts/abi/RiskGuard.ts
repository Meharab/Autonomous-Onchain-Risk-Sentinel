export const RiskGuard = [
    { 
        type: "constructor", 
        inputs: [
            { name: "_creExecutor", type: "address", internalType: "address" }, 
            { name: "_protocol", type: "address", internalType: "address" }, 
            { name: "_minCollateralRatio", type: "uint256", internalType: "uint256" }, 
            { name: "_maxCollateralRatio", type: "uint256", internalType: "uint256" }, 
    ...
    { 
        ...
        name: "protocol", 
        inputs: [], 
        outputs: [{ name: "", type: "address", internalType: "contract LendingProtocol" }], 
        stateMutability: "view" 
    }, 
    { 
        type: "function", 
    ...
    { 
        ...
        name: "setBounds", 
        inputs: [
            { name: "newMin", type: "uint256", internalType: "uint256" }, 
            { name: "newMax", type: "uint256", internalType: "uint256" }
        ], 
        outputs: [], 
        stateMutability: "nonpayable" 
    }, 
    ...
    { 
        ...
        inputs: [
            ...
            { name: "oldMax", type: "uint256", indexed: false, internalType: "uint256" }, 
            { name: "newMin", type: "uint256", indexed: false, internalType: "uint256" }, 
            { name: "newMax", type: "uint256", indexed: false, internalType: "uint256" }
        ], 
        anonymous: false 
    }, 
    { 
        ...
        inputs: [
            { name: "oldExecutor", type: "address", indexed: false, internalType: "address" }, 
    ...
    { 
        ...
        inputs: [
            { name: "previousAuthor", type: "address", indexed: true, internalType: "address" }, 
            { name: "newAuthor", type: "address", indexed: true, internalType: "address" }
        ], 
        anonymous: false 
    }, 
    { 
        ...
        inputs: [
            { name: "previousId", type: "bytes32", indexed: true, internalType: "bytes32" }, 
            { name: "newId", type: "bytes32", indexed: true, internalType: "bytes32" }
        ], 
        anonymous: false 
    }, 
    { 
    ...
    { 
        ...
        inputs: [
            { name: "previousForwarder", type: "address", indexed: true, internalType: "address" }, 
            { name  : "newForwarder", type: "address", indexed: true, internalType: "address" }
        ], 
        anonymous: false 
    }, 
    { 
    ...
    { 
        type: "event", 
        name: "RiskActionExecuted", 
        inputs: [
            { name: "riskScore", type: "uint256", indexed: false, internalType: "uint256" }, 
            { name: "newCollateralRatio", type: "uint256", indexed: false, internalType: "uint256" }, 
            { name: "borrowingPaused", type: "bool", indexed: false, internalType: "bool" }
        ], anonymous: false 
    }, 
    { 
        type: "event", 
